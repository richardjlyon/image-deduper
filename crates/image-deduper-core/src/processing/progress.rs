...
impl ProgressTracker {
    ...
    pub fn new(total_images: usize, initial_position: usize, initial_successful: usize, initial_errors: usize) -> Self {
    ...
    pub fn start_batch(&self, batch_size: usize, batch_number: usize, total_batches: usize) {
        ...
        self.batch_progress.set_message(format!("Batch {}/{}", batch_number, total_batches));
    ...
    pub fn complete_batch(&self, successful: usize, errors: usize) {
        ...
        let batch_elapsed = self.batch_start_time.lock().unwrap().elapsed().as_secs_f64();
    ...
    pub fn increment(&self, successful: usize, errors: usize) {
        ...
        let eta_secs = if speed > 0.0 { (remaining as f64 / speed) as u64 } else { 0 };
